...
class Cider:
    ...
    """
    def __init__(self, n=4, df="corpus", cider_cache=None):
        """
        ...
        self._n = n
        self._df = df
        self.cider_scorer = CiderScorer(n=self._n, df_mode=self._df, cider_cache=cider_cache)
    ...
    def my_self_cider(self, res, need_split=True, clear_cache=False):
        """
        gts a list of list
        """
        ...
        for  _res in res:
            ...
            tmp = tmp_cider_scorer.my_get_self_cider(_res, need_split=need_split, clear_cache=clear_cache)
            scores.append(tmp)
