...
class BERT(nn.Module):
    ...
    def get_sentence_features(self, tokens: List[int], pad_seq_length: int, add_special_tokens: bool=True):
        """
        ...
        return self.tokenizer.prepare_for_model(tokens, max_length=pad_seq_length, pad_to_max_length=True, return_tensors='pt', add_special_tokens=add_special_tokens)
