...
class Seq2MultiSeqDatasetReader(DatasetReader):
    ...
    def _read(self, file_path):
        ...
        with open(cached_path(file_path), "r") as data_file:
            ...
            for line_num, row in enumerate(csv.reader(data_file, delimiter=self._delimiter)):
                ...
                yield self.text_to_instance(source_sequence, target_sequences)
    ...
    @overrides
    def text_to_instance(self, source_string: str, target_strings: List[str] = None) -> Instance:  # type: ignore
        ...
        if target_strings is not None:
            ...
            return Instance({"source_tokens": source_field, "target_tokens": target_fields})
        else:
