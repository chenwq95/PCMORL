...
# Data directory
__C.DATA_LOADER.VAL_NUM = -1
__C.DATA_LOADER.TEST_NUM = -1
__C.DATA_LOADER.TRAIN_NUM = -1
__C.DATA_LOADER.ALL_SEQ_PATH = ''
...
__C.MODEL.VAR_TYPE = 'OnlyC'

__C.MODEL.M_CONSTRAINT = 'AbsMax'

__C.MODEL.TASK = 'IMAGE_CAPTIONING'
...
__C.MODEL.ATT_HIDDEN_SIZE_FORCAT = 512
...
# Variational Models
__C.MODEL.VAR = edict()
__C.MODEL.VAR.RNN_SIZE = 1024
__C.MODEL.VAR.LATENT_SIZE = 512

__C.MODEL.VAR.kld_start_inc = 6000
__C.MODEL.VAR.max_inc_steps = 25000
__C.MODEL.VAR.max_kl_weight = 1.0
__C.MODEL.VAR.lambda_var = 0.5
__C.MODEL.VAR.lambda_mu = 0.5
__C.MODEL.VAR.lambda_si = 1.0
__C.MODEL.VAR.concat_type = 'all'
__C.MODEL.VAR.component_num = 10
__C.MODEL.VAR.component_embed_size = 128


__C.MODEL.VAR.use_preference = False
__C.MODEL.VAR.preference_embed_size = 256
__C.MODEL.VAR.decoder_with_preference = False
...
__C.SOLVER.MOGRADTYPE = 'naive'    #pcgrad, mgda
...
__C.PARAM.SOURCE_SEQ = 'SOURCE_SEQ'
