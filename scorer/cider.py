...
class Cider:
    ...
    def compute_score(self, gts, res, base_res=None):
        """
        ...
        if (base_res is not None):
            #sampling phase, not greedy decoding
            #print("size of CIDEr cache scores", len(self.cider_scorer.cache_scores))
            #print("size of CIDEr cache_vecs", len(self.cider_scorer.cache_vecs))
        
            self.cider_scorer.clear_cache()
